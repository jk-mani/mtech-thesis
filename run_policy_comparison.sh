...
LOST_DEMAND_MODEL="results_GT0/activation_elu/GT0_multi_agent_dqn_final.pth"
PROFIT_MODEL="results_profit_GT0/activation_prelu/GT0_profit_dqn_best.pth"
...
def main():
    ...
    print("\n[1/2] Evaluating Lost-Demand DQN (ELU activation)...")
    ...
    print("[2/2] Evaluating Profit-Based DQN (PReLU activation)...")
